# TODO: Learn how to make RNN classify text
# Obtained classes from https://github.com/llSourcell/LSTM_Networks/blob/master/LSTM%20Demo.ipynb
# Learned how to store RNN model from https://chrisalbon.com/machine-learning/saving_machine_learning_models.html
# May rely on joblib instead of pickle library for reasons specified here https://stackoverflow.com/questions/38867587/storing-and-using-a-trained-neural-network
import numpy as np
import pickle
import joblib
...
for i in range(1, iterations):
    ...
    if error > -100 and error < 100 or i % 100 == 0:
        ...
        savedModel = pickle.dumps(RNN)
        print("Done Writing")
print("Complete")
# View the pickled model
savedModel
# Load the pickled model
RNNFromPickle = pickle.loads(savedModel)

# Use the loaded pickled model to make predictions
#RNNFromPickle.predict(X)